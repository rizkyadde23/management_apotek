...
Route::middleware('auth:sanctum')->group(function () {
    ...
    */
    ...
    Route::get(
        ...
        [AuditLogController::class, 'byUser']
    );
    Route::get(
        '/audit-logs/action/{action}',
        [AuditLogController::class, 'byAction']
    );
    Route::get(
        '/audit-logs/module/{module}',
        [AuditLogController::class, 'byModule']
    );
    Route::post(
        '/audit-logs/filter',
        [AuditLogController::class, 'filter']
    );
...
Route::middleware('role:ADMIN,OWNER,APOTEKER')->group(function () {
    ...
    Route::get(
        '/reports/my-reports',
        [ReportController::class, 'myReports']
    );
    Route::get(
        '/reports/{report}',
    ...
    Route::get(
        ...
        [ExpiredMedicineAlertController::class, 'index']
    );
    Route::get(
        '/expired-medicine-alerts/{expiredMedicineAlert}',
        [ExpiredMedicineAlertController::class, 'show']
    );
    Route::get(
        '/expired-medicine-alerts/status/{status}',
        [ExpiredMedicineAlertController::class, 'byStatus']
    );
    Route::get(
        '/expired-medicines/expiring/{daysRange}',
        [ExpiredMedicineAlertController::class, 'expiringMedicines']
    );
    Route::post(
        '/expired-medicine-alerts/generate',
        [ExpiredMedicineAlertController::class, 'generateAlerts']
    );
    Route::patch(
        '/expired-medicine-alerts/{expiredMedicineAlert}/acknowledge',
        [ExpiredMedicineAlertController::class, 'acknowledge']
    );
    Route::patch(
        '/expired-medicine-alerts/{expiredMedicineAlert}/resolve',
        [ExpiredMedicineAlertController::class, 'resolve']
    );
    Route::patch(
        '/expired-medicine-alerts/{expiredMedicineAlert}/dismiss',
        [ExpiredMedicineAlertController::class, 'dismiss']
    );
    Route::delete(
        '/expired-medicine-alerts/{expiredMedicineAlert}',
        [ExpiredMedicineAlertController::class, 'destroy']
    );
    });
});